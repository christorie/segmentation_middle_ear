...
class MyApp(MONAILabelApp):
    def __init__(self, app_dir, studies, conf):
        ...
        # Load models from app model implementation
        ...
        spatial_size = json.loads(conf.get("spatial_size", "[96, 96, 64]")) 
        
        target_spacing = json.loads(conf.get("target_spacing", "[0.21, 0.21, 0.3125]")) 
        ...
        super().__init__(
            ...
            studies=studies,
            conf=conf,
            name=f"MONAILabel - Radiology (segmentation_middle_ear)",
    ...
    # would use config.py, but not defined => Scoring skipped
...
def main():
    ...
    parser.add_argument("-m", "--model", default="segmentation_middle_ear")
